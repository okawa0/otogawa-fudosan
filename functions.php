...
?>
	<style id="sample-fudosan-critical-css">
		...
		*::after {
		...
		.hero {
			position: relative;
			background: linear-gradient(120deg, #f7fcfd 0%, #edf8fb 58%, #e3f5f8 100%);
			color: var(--text-base);
			overflow: hidden;
			border-bottom: 4px solid var(--secondary-bright)
		}
		...
		.hero__content {
			...
			border: 1px solid rgba(18, 59, 111, .12);
			padding: 22px 18px
		}
